...
const langData = {
  en: ['UP TO 40% OFF BEST-SELLING . SHOP NOW','HOME', 'SHOP', 'BLOG', 'ABOUT US', 'CONTACT US', 'Home / Shop', 'Shop Noon’i',
  ...
  az: ["ƏN ÇOX SATILANLARA 40%-Ə QƏDƏR ENDİRİM. İNDİ ALIN","Ana Səhifə", "Məhsullar", "Məqalə", "Haqqımızda", "Əlaqə", "Ana Səhifə / Satış"
  
        ,"Nooni Satış","Haqqimizda","Bizim hekaye","Bizə qoşul","Mağazaya qoşul","Təsirlər"
...
.then(data=>{
    ...
    data.slice(0,24).map(item=>{
        ...
        <button id="btn-w" style="background: none; border: none;" class="wish${item.id}" class="wish-button button">
    ...
    document.querySelector(".wish1").onclick=()=>{
        document.querySelector(".wish1").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish2").onclick=()=>{
        document.querySelector(".wish2").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish3").onclick=()=>{
        document.querySelector(".wish3").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish4").onclick=()=>{
        document.querySelector(".wish4").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish5").onclick=()=>{
        document.querySelector(".wish5").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish6").onclick=()=>{
        document.querySelector(".wish6").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish7").onclick=()=>{
        document.querySelector(".wish7").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish8").onclick=()=>{
        document.querySelector(".wish8").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish9").onclick=()=>{
        document.querySelector(".wish9").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    document.querySelector(".wish10").onclick=()=>{
        document.querySelector(".wish10").innerHTML = '<i style="color:red" class="fa-solid fa-heart"></i>'
    }
    data.map((i, c) => {
...
if (localStorage.getItem("lang") === null) {
  ...
  function multiLang() {
    ...
    .then(data=>{
        ...
        data.slice(0,24).map(item=>{
            ...
            <div class="content">
            <div style="font-size:1rem" class="product-name">${item.title.az.slice(0,27)}...</div>
  ...
  .then(data=>{
      ...
      data.slice(0,24).map(item=>{
          ...
          <label class="favorite">
          <button id="btn-w" style="background: none; border: none;" class="wish${item.id}" class="wish-button button">
          <i id="heartt${item.id}" style="color: red;" style="border:none" class="fa-regular fa-heart"></i>
...
//     document.querySelector("#btn-w").innerHTML = "fa-solid fa-heart"
//     console.log("test");
// }
...
//     document.querySelector(".wish2").innerHTML = '<i class="fa-solid fa-heart"></i>'
